        ...
        try {
            ...
            if (parameter === 'triggered') {
                homekitState = sensor.status.triggered
                    ? this.api.hap.Characteristic.CarbonMonoxideDetected.CO_LEVELS_ABNORMAL
                    : this.api.hap.Characteristic.CarbonMonoxideDetected.CO_LEVELS_NORMAL;
            } else if (parameter === 'tamper') {
                ...
                if (sensor.status) {
                    if (sensor.status.triggered) {
                        this.service.updateCharacteristic(
                            this.api.hap.Characteristic.CarbonMonoxideDetected,
                            this.api.hap.Characteristic.CarbonMonoxideDetected.CO_LEVELS_ABNORMAL
                        );
                    } else {
                        this.service.updateCharacteristic(
